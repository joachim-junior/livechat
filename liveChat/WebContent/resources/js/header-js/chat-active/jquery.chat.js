...
!function($) {
    ...
    ChatApp.prototype.save = function() {
        ...
        if (chatText == "") {
            ...
            $('<li class="clearfix"><div class="chat-avatar"><img src="/liveChat/resources/img/notification/5.jpg" alt="male"><i>' + chatTime + '</i></div><div class="conversation-text"><div class="ctext-wrap"><i>Joachim</i><p>' + chatText + '</p></div></div></li>').appendTo('ul.conversation-list');
            this.$chatInput.val('');
            this.$chatInput.focus();
